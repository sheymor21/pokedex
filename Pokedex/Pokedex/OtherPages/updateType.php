...
<html lang="en">
  ...
  <body>
     ...
     $serviciosType = new DatabaseServiceType();
     $listType = $serviciosType->GetList();
     $updateType = new Type();
     $id;
   $name;
     ...
     if(isset($_POST['Tnombre'])){
       ...
       $updateType->initialize($id,$_POST['Tnombre']);
        $serviciosType->Update($id,$updateType);
  ...
  <input type="text" class="form-control" placeholder="Nombre de tipo" aria-label="Username" aria-describedby="basic-addon1" name="Tnombre" value="<?php echo $name;?>">
</div>
